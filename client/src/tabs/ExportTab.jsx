...
import { ROUND_LEAGUES } from '../constants.js';
    ...
    <div className="tab-content">
      ...
      <p>
        {league
          ...
          : 'یک فایل Excel شامل تمام لیگ‌ها و راند سوپرتیم دانلود می‌شود؛ هر راند در برگه مخصوص به خود و هر لیگ در برگه رده‌بندی مخصوص به خودش قرار می‌گیرد.'}
      </p>
      <select value={league} onChange={(e) => setLeague(e.target.value)}>
        <option value="">همه لیگ‌ها + سوپرتیم</option>
